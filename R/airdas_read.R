#' Read AirDAS file
#'
#' Read one (or more - todo) fixed-width aerial survey DAS text file(s) 
#'   generated by turtle4d (or an associated program) into a data frame, 
...
#'
#' @details Reads/parses aerial survey DAS data into columns.
