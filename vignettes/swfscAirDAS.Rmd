...
y.eff.section$siteinfo <- y.eff.section$siteinfo %>% 
  mutate(included = ifelse(.data$Sp == "mn" & abs(.data$Angle > 60), FALSE, .data$included))
...
glimpse(airdas_comments_process(y.proc))
```
